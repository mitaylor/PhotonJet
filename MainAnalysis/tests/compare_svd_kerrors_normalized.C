...
int quantitate(char const* config, char const* selections, char const* output) {
    ...
    auto p1 = new paper(set + "_" + tag + "_svd_kerrors_normalized_comparison_" + label + "_dj", hb);
    ...
    auto p2 = new paper(set + "_" + tag + "_svd_kerrors_normalized_comparison_" + label + "_jpt", hb);
