...
int quantitate(char const* config, char const* selections, char const* output) {
    ...
    auto p1 = new paper(set + "_" + tag + "_bayes_kerrors_unnormalized_comparison_" + label + "_dj", hb);
    ...
    auto p2 = new paper(set + "_" + tag + "_bayes_kerrors_unnormalized_comparison_" + label + "_jpt", hb);
