...
int congratulate(char const* config, char const* selections, char const* output) {
    ...
    auto text_cms = (supplementary) ? "CMS #scale[0.8]{#font[52]{Preliminary}}"s : "CMS #scale[0.8]{#font[52]{Preliminary}}"s;
    ...
    if (system == 2)    legend_y_min = (subsets) ? 0.76 : 0.59;
    ...
    if (system == 4)    legend_y_min = (subsets) ? 0.76 : 0.55;
    ...
    if (system == 1)    legend_y_min = (subsets) ? 0.78 : 0.23;
    ...
    if (system == 0)    legend_y_min = (subsets) ? 0.76 : 0.78;
    ...
    if (system == 3)    legend_y_min = (subsets) ? 0.76 : 0.76;
    ...
    if (system == 4)    canvas.SaveAs((set + "_final_small_ratio_hybrid_" + name + "_log.pdf").c_str());
    if (system == 3)    canvas.SaveAs((set + "_final_small_spectra_aa_hybrid_" + name + "_log.pdf").c_str());
    if (system == 2)    canvas.SaveAs((set + "_final_small_ratio_mc_" + name + "_log.pdf").c_str());
    if (system == 1)    canvas.SaveAs((set + "_final_small_spectra_pp_" + name + "_log.pdf").c_str());
    if (system == 0)    canvas.SaveAs((set + "_final_small_spectra_aa_mc_" + name + "_log.pdf").c_str());

    if (system == 4)    canvas.SaveAs((set + "_final_small_ratio_hybrid_" + name + "_log.C").c_str());
    if (system == 3)    canvas.SaveAs((set + "_final_small_spectra_aa_hybrid_" + name + "_log.C").c_str());
    if (system == 2)    canvas.SaveAs((set + "_final_small_ratio_mc_" + name + "_log.C").c_str());
    if (system == 1)    canvas.SaveAs((set + "_final_small_spectra_pp_" + name + "_log.C").c_str());
    if (system == 0)    canvas.SaveAs((set + "_final_small_spectra_aa_mc_" + name + "_log.C").c_str());
