...
int narrate(char const* config, char const* output) {
    ...
    auto rho_ana_nominal_miniaod = new history<TH1F>(file, "rho_ana_nominal_miniaod"s);
    auto rho_ana_old_extra_aod = new history<TH1F>(file, "rho_ana_old_extra_aod"s);
    auto rho_ana_new_extra_aod = new history<TH1F>(file, "rho_ana_new_extra_aod"s);

    auto rho_pho_nominal_miniaod = new history<TH1F>(file, "rho_pho_nominal_miniaod"s);
    auto rho_pho_old_extra_aod = new history<TH1F>(file, "rho_pho_old_extra_aod"s);
    auto rho_pho_new_extra_aod = new history<TH1F>(file, "rho_pho_new_extra_aod"s);

    auto rho_ana_ratio_old_extra_aod = new history<TH1F>(file, "rho_ana_ratio_old_extra_aod"s);
    auto rho_ana_ratio_new_extra_aod = new history<TH1F>(file, "rho_ana_ratio_new_extra_aod"s);

    auto rho_pho_ratio_old_extra_aod = new history<TH1F>(file, "rho_pho_ratio_old_extra_aod"s);
    auto rho_pho_ratio_new_extra_aod = new history<TH1F>(file, "rho_pho_ratio_new_extra_aod"s);
