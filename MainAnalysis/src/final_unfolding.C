...
int plot() {
    ...
    std::vector<std::string> figures = {"binning"s, "response"s, "flattened_input"s, "purity"s, "efficiency"s, "mse_bayes_mc"s, "mse_bayes_flat"s, "mse_svd_mc"s, "mse_svd_flat"s, "bottom_line"s, "jer"s, "djr"s, "dj_inputs"s, "jpt_inputs"s};
    ...
    for (size_t i = 0; i < figures.size(); ++i) {
        ...
        switch (i) {
            ...
            {
                // get histograms
                auto file_aa = new TFile("data/arc/distillate_aa_scale.root", "read");
                auto file_pp = new TFile("data/arc/distillate_pp_scale.root", "read");

                auto hist_aa = new history<TH1F>(file_aa, "aa_scale_r_dhf_f_pt"s);
                auto hist_pp = new history<TH1F>(file_pp, "pp_scale_r_dhf_f_pt"s);
                ...
                latex.SetTextAlign(22);
                latex.SetTextAngle(90);
                latex.DrawLatex(pad_x0 * 0.3 + pad_dx * 0 + pad_x1 * 0, pad_y0 + pad_dy * 0.5, "Jet Energy Resolution");
            ...
            case 11: // djr
            {
                ...
                latex.SetTextAlign(22);
                latex.SetTextAngle(90);
                latex.DrawLatex(pad_x0 * 0.3 + pad_dx * 0 + pad_x1 * 0, pad_y0 + pad_dy * 0.5, "#Deltaj Resolution");
                latex.DrawLatex(pad_x0 * 1.3 + pad_dx * 1 + pad_x1 * 1, pad_y0 + pad_dy * 0.5, "#Deltaj Resolution");
                break;
            }
            case 12: // dj inputs
            {
                ...
                auto hist_aa = new history<TH1F>(file_aa, "aa_qcd_mebs_nonclosure_s_pure_raw_sub_pjet_u_dr_sum0"s);
                auto hist_pp = new history<TH1F>(file_pp, "pp_qcd_nominal_s_pure_raw_sub_pjet_u_dr_sum0"s);
                ...
                (*hist_aa)[3]->SetMinimum(0);
                (*hist_pp)[0]->SetMinimum(0);
                (*hist_aa)[3]->SetMaximum(30);
                (*hist_pp)[0]->SetMaximum(30);
                ...
                latex.SetTextAlign(22);
                latex.SetTextAngle(90);
                latex.DrawLatex(pad_x0 * 0.3 + pad_dx * 0 + pad_x1 * 0, pad_y0 + pad_dy * 0.5, "1/N^{#gamma} dN/d#Deltaj");
                latex.DrawLatex(pad_x0 * 1.3 + pad_dx * 1 + pad_x1 * 1, pad_y0 + pad_dy * 0.5, "1/N^{#gamma} dN/d#Deltaj");
                break;
            }
            case 13: // jpt inputs
            {
                ...
                auto hist_aa = new history<TH1F>(file_aa, "aa_qcd_mebs_nonclosure_s_pure_raw_sub_pjet_u_jpt_sum0"s);
                auto hist_pp = new history<TH1F>(file_pp, "pp_qcd_nominal_s_pure_raw_sub_pjet_u_jpt_sum0"s);
                ...
                latex.SetTextAlign(22);
                latex.SetTextAngle(90);
                latex.DrawLatex(pad_x0 * 0.3 + pad_dx * 0 + pad_x1 * 0, pad_y0 + pad_dy * 0.5, "1/N^{#gamma} dN/dp_{T}^{jet}");
                latex.DrawLatex(pad_x0 * 1.3 + pad_dx * 1 + pad_x1 * 1, pad_y0 + pad_dy * 0.5, "1/N^{#gamma} dN/dp_{T}^{jet}");
                break;
            }
        }
