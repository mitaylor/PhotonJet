    ...
    for (size_t i = 0; i < figures.size(); ++i) {
        ...
        switch (i) {
            ...
            case 2: // flattened inputs
            {
                ...
                latex.SetTextAlign(11);
                latex.SetTextAngle(0);
                latex.DrawLatex(0.17, 0.64, (text_photon_pt + ", " + text_photon_eta + ", " + text_dphi).c_str());
                latex.DrawLatex(0.17, 0.58, (text_jet_alg + ", " + text_jet_pt + ", " + text_jet_eta).c_str());
                ...
                latex.SetTextAlign(22);
                latex.SetTextAngle(90);
                latex.DrawLatex(pad_x0 * 0.3 + pad_dx * 0 + pad_x1 * 0, pad_y0 + pad_dy * 0.5, "Counts");
                latex.DrawLatex(pad_x0 * 1.3 + pad_dx * 1 + pad_x1 * 1, pad_y0 + pad_dy * 0.5, "Counts");
                break;
            }
        }
