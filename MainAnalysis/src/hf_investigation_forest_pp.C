...
int Compare(char const* config, char const* output) {
    ...
    auto fnpu = [&](int64_t, std::string const& name, std::string const& label) {
        return new TProfile(name.data(), (";nPU;HF Energy;"s + label).data(), 18, 0, 18, 0, 70000, "LE"); };
    ...
    for (int i = 1; i < entries; ++i) {
        ...
        (*h_npu_hf_pf_energy_selected)[0]->Fill((*npus)[5], pf_energy_sum, *weight);
    }
    ...
    c2->add((*h_pthat_selected)[0], "PP MC");
    hb->sketch();
    c2->draw("pdf");
    ...
    for (int64_t j = 0; j < iphoton->size(); ++j) {
        c3->add((*h_hf_pf_energy_selected)[j], "PP MC");
    }
    hb->sketch();
    c3->draw("pdf");
    ...
    c30->add((*h_hf_pf_eta_selected)[0], "PP MC");
    hb->sketch();
    c30->draw("pdf");
    ...
    for (int64_t j = 0; j < iphoton->size(); ++j) {
        c31->add((*h_hf_pf_pt_selected)[j], "PP MC");
    }
    hb->sketch();
    c31->draw("pdf");
    ...
    c4->add((*h_npu_hf_pf_energy_selected)[0], "PP MC");
    hb->sketch();
    c4->draw("pdf");
    ...
    c5->add((*h_hf_gen_energy_selected)[0], "PP MC");
    hb->sketch();
    c5->draw("pdf");
    ...
    c6->add((*h_hf_gen_energy_selected_subid0)[0], "PP MC");
    hb->sketch();
    c6->draw("pdf");
    ...
    c50->add((*h_hf_gen_eta_selected)[0], "PP MC");
    hb->sketch();
    c50->draw("pdf");
    ...
    c60->add((*h_hf_gen_eta_selected_subid0)[0], "PP MC");
    hb->sketch();
    c60->draw("pdf");
    ...
    c51->add((*h_hf_gen_pt_selected)[0], "PP MC");
    hb->sketch();
    c51->draw("pdf");
    ...
    c61->add((*h_hf_gen_pt_selected_subid0)[0], "PP MC");
    hb->sketch();
    c61->draw("pdf");
    ...
    c7->add((*h_hf_gen_energy)[0], "PP MC");
    hb->sketch();
    c7->draw("pdf");
    ...
    c8->add((*h_hf_gen_energy_subid0)[0], "PP MC");
    hb->sketch();
    c8->draw("pdf");
