...
int quantitate(char const* config, char const* selections, char const* output) {
    ...
    unfolded->rename(tag + "_"s + label + "_raw_sub_pjet_u_dr_sum0_unfolded"s);
    unfolded_fold0->rename(tag + "_"s + label + "_raw_sub_pjet_u_dr_sum0_unfolded_fold0"s);
    unfolded_fold1->rename(tag + "_"s + label + "_raw_sub_pjet_u_dr_sum0_unfolded_fold1"s);
