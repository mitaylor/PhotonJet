    ...
    for (size_t i = 0; i < figures.size(); ++i) {
        ...
        switch (i) {
            ...
            case 1: // closure MC, D'Agostini, MC prior
            {
                ...
                latex.SetTextAlign(11);
                latex.SetTextAngle(0);
                latex.DrawLatex(0.50, 0.74, "Source: MC");
            ...
            case 3: // closure Jewel, D'Agostini, flat prior
            {
                // get histograms
                auto file_aa = new TFile("data/arc/pho_60_rebin1/compare_unfolding_closure_gen_aa_jewel_aa_flat.root", "read");
                auto file_pp = new TFile("data/arc/pho_60_rebin1/compare_unfolding_closure_gen_pp_jewel_aa_flat.root", "read");
                ...
                latex.DrawLatex(0.50, 0.74, "Source: Jewel PbPb");
                latex.DrawLatex(0.50, 0.68, "Algorithm: D'Agostini");
                latex.DrawLatex(0.50, 0.62, "Prior: Flat");
