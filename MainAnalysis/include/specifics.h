...
constexpr float ecuts[ip::nip][det::ndet][wp::nwp][var::nele] = {
    {    /* ip::incl */
        {    /* det::barrel */
            {    -1., 0.01020, 0.00327, 0.06055, 0.52688 }, /* wp::veto */
            {    -1., 0.00997, 0.00272, 0.03419, 0.03101 }, /* wp::loose */
            {    -1., 0.00948, 0.00272, 0.03415, 0.02762 }, /* wp::medium */
            {    -1., 0.00922, 0.00268, 0.02609, 0.02711 }, /* wp::tight */
            {    -1.,     -1.,     -1.,     -1.,     -1. }  /* wp::claustro */
        }, { /* det::endcap */
            {    -1., 0.02957, 0.00490, 0.09622, 0.14600 }, /* wp::veto */
            {    -1., 0.02895, 0.00488, 0.02983, 0.01873 }, /* wp::loose */
            {    -1., 0.02685, 0.00379, 0.02812, 0.01614 }, /* wp::medium */
            {    -1., 0.02679, 0.00377, 0.02762, 0.00472 }, /* wp::tight */
            {    -1.,     -1.,     -1.,     -1.,     -1. }  /* wp::claustro */
        }
    }, { /* ip::cent */
        {    /* det::barrel */
