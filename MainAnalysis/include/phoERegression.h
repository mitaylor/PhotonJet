...
int phoERegression::initialiseReader(std::string pathXml, int iEBEE)
{
    tmvaReaders[iEBEE] = 0;
...
int phoERegression::initialiseReaderEB(std::string pathXmlEB)
{
    return initialiseReader(pathXmlEB, 0);
}

int phoERegression::initialiseReaderEE(std::string pathXmlEE)
{
