...
samples=(pp_raw pp_bkg pp_qcd_raw pp_qcd_bkg pp_qcd_gen_iso_raw pp_qcd_gen_iso_bkg pp_wo_ele_rej_raw pp_wo_ele_rej_bkg pp_qcd_er_raw pp_qcd_er_bkg pp_er_raw pp_er_bkg pp_es_raw pp_es_bkg)
