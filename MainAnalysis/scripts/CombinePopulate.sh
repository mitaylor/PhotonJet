...
samples=(pp_raw pp_bkg pp_qcd_raw pp_qcd_bkg pp_qcd_gen_iso_raw pp_qcd_gen_iso_bkg pp_wo_ele_rej_raw pp_wo_ele_rej_bkg pp_er_raw pp_er_bkg pp_es_up_raw pp_es_up_bkg pp_es_down_raw pp_es_down_bkg)
...
samples=(aa_raw aa_bkg aa_qcd_raw aa_qcd_bkg aa_qcd_gen_iso_raw aa_qcd_gen_iso_bkg aa_wo_ele_rej_raw aa_wo_ele_rej_bkg aa_cent_down_raw aa_cent_down_bkg aa_cent_up_raw aa_cent_up_bkg aa_no_eff_raw aa_no_eff_bkg aa_no_er_raw aa_no_er_bkg aa_es_up_raw aa_es_up_bkg aa_es_down_raw aa_es_down_bkg)
