...
./bin/ratio configs/congratulate/ratio_cut.conf configs/analysis/${set}/analysis_pp.conf temp.root
./bin/ratio configs/congratulate/ratio_unnormalized.conf configs/analysis/${set}/analysis_pp.conf temp.root
./bin/ratio configs/congratulate/ratio_unnormalized_cut.conf configs/analysis/${set}/analysis_pp.conf temp.root
