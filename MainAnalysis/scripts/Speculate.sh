...
run_pp() {
    ...
    ./bin/speculate configs/speculate/preapproval/speculate_${tag}.conf configs/analysis/${set}/analysis_pp.conf data/preapproval/${set}/speculate_${tag}.root > log/${set}_speculate_${tag}.txt 2>&1 &
}
