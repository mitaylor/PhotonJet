...
for sample in ${samples[@]}; do
    ...
    ./bin/vary_response_matrix configs/vary_response_matrix/vary_response_matrix_${sample}_weighted.conf \
        configs/analysis/${set}/analysis_pp.conf data/preapproval/${set}/vacillate_weight_${sample}_stat_response.root
done
...
for sample in ${samples[@]}; do
    ...
    ./bin/vary_response_matrix configs/vary_response_matrix/vary_response_matrix_${sample}_weighted.conf \
        configs/analysis/${set}/analysis_aa.conf data/preapproval/${set}/vacillate_weight_${sample}_stat_response.root
done