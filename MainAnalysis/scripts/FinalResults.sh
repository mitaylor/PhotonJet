...
./bin/final_results_data_ratio_spectra configs/final/final_results_data_ratio_whole_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_data_ratio_spectra configs/final/final_results_data_ratio_subsets_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_data_ratio_spectra configs/final/final_results_data_spectra_whole_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_data_ratio_spectra configs/final/final_results_data_spectra_subsets_log.conf configs/analysis/${set}/analysis_aa.conf test.root
...
./bin/final_results_theory_ratio_spectra configs/final/final_results_theory_spectra_aa_whole_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_theory_ratio_spectra configs/final/final_results_theory_spectra_aa_subsets_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_theory_ratio_spectra configs/final/final_results_theory_spectra_pp_whole_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_theory_ratio_spectra configs/final/final_results_theory_spectra_pp_subsets_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_theory_ratio_spectra configs/final/final_results_theory_ratio_whole_log.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_theory_ratio_spectra configs/final/final_results_theory_ratio_subsets_log.conf configs/analysis/${set}/analysis_aa.conf test.root