...
./bin/final_results_theory_ratio_spectra_whole configs/final/final_results_theory_spectra_aa_whole.conf configs/analysis/${set}/analysis_aa.conf test.root
...
./bin/final_results_theory_ratio_spectra_whole configs/final/final_results_theory_ratio_whole.conf configs/analysis/${set}/analysis_aa.conf test.root
