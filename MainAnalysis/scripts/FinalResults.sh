...
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_spectra_aa_mc_whole.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_spectra_aa_mc_subsets.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_spectra_aa_hybrid_whole.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_spectra_aa_hybrid_subsets.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_spectra_pp_whole.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_spectra_pp_subsets.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_ratio_mc_whole.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_ratio_mc_subsets.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_ratio_hybrid_whole.conf configs/analysis/${set}/analysis_aa.conf test.root
./bin/final_results_small_ratio_spectra configs/final/final_results_theory_ratio_hybrid_subsets.conf configs/analysis/${set}/analysis_aa.conf test.root
