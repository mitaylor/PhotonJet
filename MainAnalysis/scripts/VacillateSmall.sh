...
run_pp() {
    ...
    echo "nohup ./bin/vacillate configs/vacillate/vacillate_${tag}.conf configs/analysis/${set}/analysis_pp.conf data/arc/${set}/vacillate_original_${tag}.root > log/${set}_vacillate_original_${tag}.txt 2>&1 &"
}
...
run_aa() {
    ...
    echo "nohup ./bin/vacillate configs/vacillate/vacillate_${tag}.conf configs/analysis/${set}/analysis_aa.conf data/arc/${set}/vacillate_original_${tag}.root > log/${set}_vacillate_original_${tag}.txt 2>&1 &"
}
