#ifndef PHOEREGRESSIONNEW_H_
#define PHOEREGRESSIONNEW_H_
 ...
 * How to use
 *
 phoERegressionNew myPhoERegr;
 myPhoERegr.initialiseReaderEB(<pathXMLfileforEB>); // /afs/cern.ch/work/k/katatar/public/photonEnergyRegression/tmvaTrainRegr_BDTG_pbpb18_EB.xml
 myPhoERegr.initialiseReaderEE(<pathXMLfileforEE>); // /afs/cern.ch/work/k/katatar/public/photonEnergyRegression/tmvaTrainRegr_BDTG_pbpb18_EE.xml
...
class phoERegressionNew {
  public :
    ...
    ~phoERegressionNew(){};
    int initialiseReader(std::string pathXml, int iEBEE);
    int initialiseReaderEB(std::string pathXmlEB);
    int initialiseReaderEE(std::string pathXmlEE);
...
int phoERegressionNew::initialiseReader(std::string pathXml, int iEBEE)
{
    tmvaReaders[iEBEE] = 0;
...
int phoERegressionNew::initialiseReaderEB(std::string pathXmlEB)
{
    return initialiseReader(pathXmlEB, 0);
}

int phoERegressionNew::initialiseReaderEE(std::string pathXmlEE)
{
    return initialiseReader(pathXmlEE, 1);
}

void phoERegressionNew::addVariables(int iEBEE)
{
...
void phoERegressionNew::addVariablesEB()
{
    addVariables(0);
}

void phoERegressionNew::addVariablesEE()
{
    addVariables(1);
}

void phoERegressionNew::addSpectators(int iEBEE)
{
...
std::vector<float> phoERegressionNew::evalRegression(std::vector<float> & phoVars, int iEBEE)
{
...
float phoERegressionNew::getCorrectedEnergy(std::vector<float> & phoVars, int iEBEE)
{
    std::vector<float> targets_regr = evalRegression(phoVars, iEBEE);
    return targets_regr[0];
}

float phoERegressionNew::getCorrectedPtEBEE(std::vector<float> & phoVars, float phoEt, float phoEta, int iEBEE)
{
...
float phoERegressionNew::getCorrectedPt(std::vector<float> & phoVars, float phoEt, float phoEta, float phoSCEta)
{
